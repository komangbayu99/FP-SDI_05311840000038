...
def telesend(text):
    url = "https://api.telegram.org/bot1416854022:AAH1fKZ1Jp4oNlzz7_B2q6KiDpQbj9pISng/sendMessage?chat_id=675910890&parse_mode=Markdown&text=" + text
    requests.get(url)
...
while (ret):
    ...
    for c in range(len(contours)):
        ...
        if Area > 4000:
            ...
            cv2.imwrite("in_memory_to_disk.png", frame)
